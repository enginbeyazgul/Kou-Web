...
class DgsController extends Controller
{
    ...
    public function dgsBasvuru(Request $request){
        ...
        $addedDocRef->set([
            ...
            'petitionPath' => '1',
            'lessonPath' => 'DGS/pdf/LessonContent/'.Session::get('studentId').'.pdf',
            'transcriptPath' => 'DGS/pdf/Transcript/'.Session::get('studentId').'.pdf',
            'type' => 'Dgs',
        ...
        return redirect('ogrencimain/bekleyen',$pdf)->withErrors(['msg' => 'Lütfen İmzalı Pdf Dosyasını Yükleyiniz.']);
    }
}
