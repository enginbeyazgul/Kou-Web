...
@section('ead')
    <div class="containerr">
        <div class="columnn">
            ...
            @endif
            <div class="row"><h2> Bekleyen İntibak Başvuruları</h2></div>
            ...
            @endif
            <div class="row"><h2> Onaylanan İntibak Başvuruları</h2></div>
            ...
            @else
                <div  class="row"><div style="justify-content: center" class="basvuru"><div >Başvuru Bulunamadı.</div></div></div>
            @endif
            <div class="row"><h2> Reddedilen İntibak Başvuruları</h2></div>
