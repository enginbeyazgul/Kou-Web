...
@section('ead')
    <div class="containerr">
        <div class="columnn">
            ...
            @endif
            <div class="row"><h2> Bekleyen Yatay Geçiş Başvuruları</h2></div>
                        ...
                        <div class="basvuru">
                            ...
                            <div>
                                <form style="display: flex" action="{{route('adminmain/islem')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <button style="font-size: 18px;margin:3px; padding: 7px 10px"  id="indirdilekce" name="action" class="file-input-aa" type="submit" value="onayla"><i class="fas fa-check-circle"></i></button>
            ...
            @endif
            <div class="row"><h2> Onaylanan Yatay Geçiş Başvuruları</h2></div>
            ...
            @else
                <div  class="row"><div style="justify-content: center" class="basvuru"><div >Başvuru Bulunamadı.</div></div></div>
            @endif
            <div class="row"><h2> Reddedilen Yatay Geçiş Başvuruları</h2></div>
                        ...
                        <div class="basvuru">
                            ...
                            <div>
                                <form style="display: flex" action="{{route('adminmain/islem')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <button style="font-size: 18px;margin:3px; padding: 7px 10px"  id="indirdilekce" name="action" class="file-input-aa" type="submit" value="onayla"><i class="fas fa-check-circle"></i></button>
                                    <button style="background-color: #d0143a; font-size: 18px;margin:3px; padding: 7px 10px" name="action" class="file-input-aa" type="submit" value="reddet"><i class="fas fa-times-circle"></i></button>
                                    <button style="background-color: #f1c12f; font-size: 18px;margin:3px; padding: 7px 10px" id="reddedilenindirdilekce" class="file-input-aa" type="button"><i class="fas fa-file-download"></i></button>
                            </div>
                        </div>
