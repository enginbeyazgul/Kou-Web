...
Route::post('/ogrencimain/bekleyen', [\App\Http\Controllers\BasvuruDurumController::class, 'dilekceYukle'])->name('dilekceyukle');
Route::post('/logout', [\App\Http\Controllers\LogoutAll::class,'logoutAll'])->name('logout');
Route::post('/adminmain/islem', [\App\Http\Controllers\AdminIslemController::class,'islem'])->name('adminmain/islem');
